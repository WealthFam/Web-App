...
export const financeApi = {
    ...
    deleteRule: (id: string, migrateTo?: string) => apiClient.delete(`/finance/rules/${id}`, { params: { migrate_to: migrateTo } }),
    analyzeRules: () => apiClient.get<any>('/finance/rules/analysis'),
